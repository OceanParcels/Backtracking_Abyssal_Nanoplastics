...
python3 backtrack_sampling_locations.py -ft 10000 -bm 1 -s 13
sleep 60
python3 backtrack_from_existing_file.py -ft 10000 -bm 1 -s 77
sleep 60
python3 backtrack_sampling_locations.py -ft 10000 -bm 1 -s 29
sleep 60
python3 backtrack_sampling_locations.py -ft 10000 -bm 1 -s 61
